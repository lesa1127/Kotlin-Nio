...
interface DataOutput {
     ...
     * @throws     IOException  if an I/O error occurs.
     */
    suspend fun writeBoolean(v: Boolean)
     ...
     * @throws     IOException  if an I/O error occurs.
     */
    suspend fun writeFloat(v: Float)
     ...
     * @throws     IOException  if an I/O error occurs.
     */
    suspend fun writeDouble(v: Double)
     ...
     * @throws     IOException  if an I/O error occurs.
     */
    suspend fun writeBytes(s: String)
     ...
     * @throws     IOException  if an I/O error occurs.
     */
    suspend fun writeChars(s: String)
